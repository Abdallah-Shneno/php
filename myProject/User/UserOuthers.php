 ...
 <ul id="nav">
	...
	<div class="myBox">
		...
		<span>
			...
			<form style="margin-left: 70%; position: relative;" action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
...
<div class="myGroup">
					...
					//	echo "db connection done";
										...
										// (description LIKE '%$keywords%' OR item LIKE '%$keywords%')
												...
												$query = "SELECT * from book where BookOuther_name = '$value' ";
