...
<body>
 ...
 <ul id="nav">
          <li><a href="ShowAllBooks.php">All Books</a></li>
          <li><a href="AddNewBook.php">Add New Book</a></li>
          <li><a href="..\Categories\CategoryPage.php">Categories</a></li>
          <li><a href="..\Outhers\OutherPage.php">Outhers</a></li>
          <li><a href="..\Publish\PublishPage.php">Publisher</a></li>
          <li><a href="https://localhost/myProject/Admin/Outhentication/login.php">Log Out</a></li>
        </ul>




	<h3 class="titlesA1">Show All Books </h3>
...
<div class="myGroup">
								...
								if (mysqli_num_rows($result) > 0) {
											while ($row = mysqli_fetch_assoc($result) ) {
												...
												echo '<td>'.'<div class="item">' 
												 ...
												 .'<p>State '. $row['state'].'</p>'
												 .'<a class="updatebtn" href="UpdateBook.php?id='. $row['id'] . '">Update</a>'
												 .'<a class="deletebtn" href="actionDelete.php?id='. $row['id'] . '">Delete</a>'.
												 '</div>'.'</td>';
  ...
  <div id="footer">
      <p class="copyright">Copyright &#8858; 2020 IUG  | <a id="name" href="#">Coding by ABDALLAH SHNENO</a> | <a style="color: black; text-shadow: .2px 0px #000000;;" href="#">Support</a></p>
    </div>
	    </div>
