...
<div class="deleteherDesign">
	...
	<?php 
		...
		$connection = mysqli_connect('localhost','root','','booksystem');
			...
			$query = "SELECT name from publish";
	...
	<div class="addOutherDesign">
		<div class="my_div">
			<h3>Add New Publisher Part</h3>
				<form action="PublishOperations.php?oid=1" method="POST">
				<label class="headers" for="bookImage_id">New Publisher Name</label>
	...
	<div class="updateOutherDesign">
		<div class="my_div">
				<h3>Update Publisher Part</h3>
				<form action="PublishOperations.php?oid=2" method="POST">
				<label class="headers" for="bookImage_id">Old Publisher Name</label>
				...
				<br><br><br>
				<label class="headers" for="updateNewOutherName">New Publisher Name</label>
	...
	<div class="deleteherDesign">
		<div class="my_div">
				<h3>Delete Publisher Part</h3>
				<form action="PublishOperations.php?oid=3" method="POST">
				<label class="headers" for="deleteOuther">Publisher Name</label>
