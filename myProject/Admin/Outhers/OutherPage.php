...
<div class="deleteherDesign">
	...
	<div class="addOutherDesign">
		<div class="my_div">
			<h3>Add New Outher Part</h3>
				<form action="OutherOperations.php?oid=1" method="POST">
				<label class="headers" for="bookImage_id">New Outher Name</label>
	...
	<div class="updateOutherDesign">
		<div class="my_div">
				<h3>Update Outher Part</h3>
				<form action="OutherOperations.php?oid=2" method="POST">
				<label class="headers" for="bookImage_id">Old Outher Name</label>
				...
				<br><br><br>
				<label class="headers" for="updateNewOutherName">New Outher Name</label>
	...
	<div class="deleteherDesign">
		<div class="my_div">
				<h3>Delete Outher Part</h3>
				<form action="OutherOperations.php?oid=3" method="POST">
				<label class="headers" for="deleteOuther">Outher Name</label>
